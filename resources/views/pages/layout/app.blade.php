...
<head>
    ...
    <title>ExclusiveNFTart - NFT Marketplace</title>
    <meta name="description"
          content="ExclusiveNFTart is NFT. Here included bids, collection, wallet, and all user setting pages including profile, application, activity, payment method, api, sign in & sign up etc.">
                    ...
                    <div class="navigation">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <div class="brand-logo">
                                <a href="{{ route('index') }}">
                                    <img style="margin-bottom: -20px; margin-top: -20px" height="100" width="150" src="{{ asset('img/logo.png') }}" alt="" class="logo-primary">
...
{{--                        <h3 class="pb-3 text-white">ExclusiveNFTart</h3>--}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="copyright">
                        <p class="text-white">© Copyright 2022 <a href="#" class="text-white">ExclusiveNFTart</a> <!-- -->All Rights Reserved</p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
