            ...
            <div class="nk-content-body">
                    ...
                    <div class="nk-block-between-md g-4">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des">
                                <p>List of all pending/cancelled deposits</p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                            <ul class="nk-block-tools gx-3">
                                <li class="order-md-last"><a href="{{ route('user.deposit') }}" class="btn btn-primary"><span>Deposit</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                ...
                <ul class="nk-nav nav nav-tabs">
                    ...
                    <li class="nav-item active current-page">
                        <a class="nav-link" href="{{ route('user.transactions') }}">Deposits</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('user.pendingTransactions') }}">Scheduled <span class="badge badge-primary">{{ $count }}</span></a>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <div class="tranx-info">
                                        ...
                                        <div class="tranx-data">
                                            ...
                                            @if($item->status == 0)
                                                ...
                                                <a href="{{ route('user.cancelDeposit', $item->id) }}"  class="link link-danger">Cancel</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
